...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_SURVEYORS_POST, "Surveyor's post"},
    {TR_BUILDING_SURVEYORS_POST_DESC, "Materials for upgrading houses are gathered here and then distributed by the surveyor."},
    ...
    {TR_SURVEYORS_POST_SPECIAL_ORDERS_HEADER, "Surveyor's post instructions"},
